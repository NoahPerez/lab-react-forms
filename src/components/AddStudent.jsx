...
function AddStudent({ handleAddStudent }) {
  ...
  const handleGradutionYear = e => setGraduationYear(Number(e.target.value))

  const handleGradution = e => setGraduated(e.target.checked)
